<template>
	<view class="uni-numbox">
		<view @click.stop.prevent="_calcValue('minus')" class="uni-numbox__minus uni-numbox-btns" :style="{background}">
		...
		<view @click.stop.prevent="_calcValue('plus')" class="uni-numbox__plus uni-numbox-btns" :style="{background}">
